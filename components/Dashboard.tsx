...
import { Plus, Clock, CheckCircle2, ArrowUpRight, Folder, Shield, Users, Eye, LogOut, LayoutGrid, List, ChevronDown, Edit, Trash2, X, ClipboardList } from 'lucide-react';
...
export const Dashboard: React.FC<DashboardProps> = ({ currentUser, projects, users, onNewProject, onSelectProject, onLogout, onEditProject, onDeleteProject }) => {
                    ...
                    <div className="flex-1">
                        ...
                        <div className="absolute top-0 right-0 p-4 flex items-center gap-2">
                           ...
                           {activeTab === 'ALL' && (
                              ...
                              myRole === 'Owner' ? 'bg-indigo-100 text-indigo-700' :
                      ...
                      <div className="flex items-center gap-3 mb-1">
                         ...
                         {activeTab === 'ALL' && (
                            <span className={`text-[10px] font-bold px-2 py-0.5 rounded-full uppercase tracking-wider ${
                              myRole === 'Owner' ? 'bg-indigo-50 text-indigo-700' :
